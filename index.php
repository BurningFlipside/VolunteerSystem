...
<script type="text/javascript">
  function doYes(){
      var answer=window.currentNode.GetYes();handleNode(answer)
  }
  function doBack(){
  ...
  function doNo(){
    var answer=window.currentNode.GetNo();handleNode(answer);
  }
  ...
  function handleNode(answer){
    if(answer instanceof VolunteerPosition){
      ...
      window.currentNode=answer;updateQuestionText();
    }
