...
$page->add_js_from_src('scripts/init_page.js', false);
$page->add_js_from_src('scripts/question_node.js', false);
$page->add_js_from_src('scripts/volunteer_position.js', false);
