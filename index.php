...
$page->addJS('js/question_node.js');
$page->addJS('js/volunteer_position.js');
$page->addJS('js/init_page.js');
...
<div id="VC_Footer">
    ...
    <p>
    Confused about anything you see here?  Did you find an error or a dead link?  You might want to visit the <a href="'.$page->wikiUrl.'/wiki/Volunteer_Coordinator">Volunteer Coordinator page on Pyropedia</a> or email the volunteer team at <a href="mailto:volunteerinfo@burningflipside.com">volunteerinfo@burningflipside.com</a>
    </p>
</div>
</div>
